              ...
              <Card key={item.bill_info.bill_id} className="z-10 overflow-visible">
                <CardBody className="py-3 overflow-visible">
                  <Link
                    ...
                    className={`absolute -left-[39px] flex items-center justify-center w-7 h-7 rounded-full shadow-lg shrink-0 border-1.5 bg-white dark:bg-dark-b ${item.bill_info.party_info[0].party_name} lg:hidden`}>
                    <Image
