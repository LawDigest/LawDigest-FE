            ...
            {promulgation_list.length !== 0 ? (
              <div className="flex items-center justify-between ">
                <Link
                  ...
                  <Image
                    src={`${process.env.NEXT_PUBLIC_IMAGE_URL}${isDark ? promulgation_list[currentPage].party_info[0].party_image_url.replace('wide', 'dark') : promulgation_list[currentPage].party_info[0].party_image_url}`}
                ...
                <div className="flex flex-col w-full gap-2">
                  ...
                  <div className="flex items-center gap-[6px]">
                    ...
                    <p className="text-xs font-semibold text-gray-2 dark:text-gray-3">
                      {promulgation_list[currentPage].bill_proposers}
                    </p>
                  </div>
                </div>
                <Button
