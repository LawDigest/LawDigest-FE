...
export default function Notification() {
  return (
    <div>
      ...
      <ItemList title="이번 주">
        {weekList.map(({ logo, name, law, members_number }) => (
          <Item logo={logo} name={name} law={law} members_number={members_number} key={name} />
        ))}
      </ItemList>
      ...
      <ItemList title="이번 달">
        {monthList.map(({ logo, name, law, members_number }) => (
          <Item logo={logo} name={name} law={law} members_number={members_number} key={name} />
        ))}
      </ItemList>
    </div>
